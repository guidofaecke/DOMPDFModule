...
final class ConfigProvider
{
    ...
    public function getDOMPDFModuleConfig(): array
    {
        return [
            /**
             ...
             * *Please note the trailing slash.*
             */
            'font_directory' => \ComposerLocator::getPath('dompdf/dompdf') . '/lib/fonts/',
             ...
             */
            'font_cache_directory' => \ComposerLocator::getPath('dompdf/dompdf') . '/lib/fonts/',
             ...
             */
            'chroot' => \ComposerLocator::getPath('dompdf/dompdf'),
